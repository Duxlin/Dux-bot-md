...
<h2 align="center">Dux-bot-md</h2>

This is Script of WhatsApp multi device, working with [`@adiwajshing/baileys`](https://github.com/adiwajshing/baileys)

## My Project
* New script to replace this script [`look here`](https://github.com/Duxlin/Dux-bot-md) (`Support Legacy or Baileys`)
...
```bash
git clone https://github.com/Duxlin/Dux-bot-md
cd Dux-bot-md
npm install
```
...
* [`Duxlin`](https://github.com/Duxlin)
* [`Quad-hir`](https://github.com/Quad-hir)
